            ...
            <div class="container-fluid col-12 col-md-10 col-lg-8 col-xl-8">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="container col-sm-12 col-md-6 col-lg-3 p-3">
                        <div class="card" style="height: 21rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                                 class="bi bi-people-fill mt-3 card-img-top" viewBox="0 0 16 16">
                    ...
                    <div class="container col-sm-12 col-md-6 col-lg-3 p-3">
                        <div class="card" style="height: 21rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                                 class="bi bi-person-lines-fill mt-3 card-img-top" viewBox="0 0 16 16">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center">
                                    <a href="/queries/" class="btn btn-primary">Wnioski <span
                    ...
                    <div class="container col-sm-12 col-md-6 col-lg-3 p-3">
                        <div class="card" style="height: 21rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                                 class="bi bi-images mt-3 card-img-top" viewBox="0 0 16 16">
                    ...
                    <div class="container col-sm-12 col-md-6 col-lg-3 p-3">
                        <div class="card" style="height: 21rem;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor"
                                 class="bi bi-journal-text mt-3 card-img-top" viewBox="0 0 16 16">
