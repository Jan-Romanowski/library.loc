                              ...
                              <div class="card-body bg-light">
                                  ...
                                  <div class="container text-center mt-4">
                                      <button type="button" class="btn btn-outline-success m-1" data-bs-toggle="modal"
                                              data-bs-target="#staticBackdrop<?php echo $queriesListItem["id_query"]; ?>">
                                          Akceptować
                                      </button>
                                      <div class="modal fade"
                                           id="staticBackdrop<?php echo $queriesListItem["id_query"]; ?>"
                                           data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                           aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                          <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                  <form action="/queries/transferQuery/<?php echo $queriesListItem["id_query"]; ?>"
                                                        method="post">
                                                      <div class="modal-header">
                                                          <h5 class="modal-title" id="staticBackdropLabel">Wniosek o
                                                              rejestracje
                                                              - <?php echo $queriesListItem["name"] . ' ' . $queriesListItem["surname"]; ?></h5>
                                      ...
                                      <button type="button" class="btn btn-outline-danger m-1" data-bs-toggle="modal"
                                              data-bs-target="#exampleModal<?php echo $queriesListItem["id_query"]; ?>">
                                          Usunąć
                                      ...
                                      <!-- Modal -->
                                      <div class="modal fade"
                                           id="exampleModal<?php echo $queriesListItem["id_query"]; ?>" tabindex="-1"
                                           aria-labelledby="exampleModalLabel" aria-hidden="true">
                                          <div class="modal-dialog modal-dialog-centered">
                                              <div class="modal-content">
                                                  <div class="modal-header">
                                                      <h5 class="modal-title" id="exampleModalLabel">Napewno chcesz
                                                          usunąć ten wniosek ?</h5>
                                                      <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                              aria-label="Close"></button>
                                                  </div>
                                                  <div class="modal-footer">
                                                      <button type="button" class="btn btn-outline-danger w-25"
                                                              onclick=document.location="/queries/deleteQuery/<?php echo $queriesListItem["id_query"]; ?>">
                                                          Tak
                                                      </button>
