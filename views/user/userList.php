    ...
    <table class='table table-hover p-3'>
        ...
        foreach ($userList as $userListItem): ?>
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-outline-danger <?php if(User::checkRoot('moder')) echo 'disabled'; ?>" data-bs-toggle="modal" data-bs-target="#staticBackdrop<?php echo $userListItem['id_account']; ?>">
