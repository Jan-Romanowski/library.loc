    ...
    <div class='container-fluid text-white' style='background-color: rgba(1,1,1, 0.7); min-height: 100vh'>
        <div class="container-fluid row gx-0 justify-content-center">
            <div class="container-fluid col-sm-12 col-md-10 col-lg-8 mb-3">
                ...
                <div class="container-fluid text-start gx-sm-1 gx-md-2 gx-lg-5">
                    <img id='szulik-container__image' src="/img/szulik.jpeg" width="300px"
                         style="margin: 0 0 2% 2%; float: right;">

                    <p align="justify">
                        Ukończył PSM II stopnia w Lublinie w klasie śpiewu solowego prof. Aliny Naumowicz.
                        Swoje umiejętności śpiewacze doskonalił także u Prof. Jadwigi Gałeskiej-Trit (Poznań), Alicji
                        Molędy-Borkowskiej
                    ...
                    <p>
                        ...
                        <ul>
                        <li>
                            <span class='szulik__change-font'>"Te Deum laudamus"</span> - na sopran solo, chór mieszany, zespół
                            instrumentów dętych i organy
                            (prawykonanie - styczeń 2001, 6 koncertów w diecezji siedleckiej)
                        </li>
                        <li>
                            <span class='szulik__change-font'>Mottet "Evangelio oboedientia. Eucharistia."</span> - na 3 chóry
                            mieszane, kwartet dęty i organy
                            (prawykonanie - czerwiec 2002)
                        </li>
                        <li>
                            <span class='szulik__change-font'> "Requiem f-moll"</span> - na sopran i tenor solo, chór mieszany i
                            organy (prawykonanie - lipiec 2004,
                            koncert w Überlingen 2005)
                        </li>
                        <li>
                            <span class='szulik__change-font'> Psalm 150</span> - na chór mieszany i organy (prawykonanie -
                            listopad 2004)
                        </li>
                    </ul>
                    </p>
