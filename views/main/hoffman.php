...
<div class="container-fluid text-light text-lg-start gx-5 m-0 pb-5" style="background-color: rgba(1,1,1, 0.7); margin-top: 20px; width: 100%;">
    <div class="container-fluid p-5">
        <div style="text-align: center">
            ...
            <img src="/img/hoffman.jpeg" width="200px" class = "img" style="float: left; margin-right: 20px;">
        </div>
        <p align="justify">
        ...
        <p align="justify">
            ...
            Komisji Liturgicznej, <img src="/img/hoffman2.jpeg" class="img" style="float: right; margin: 20px"> do której został
        ...
        </p><hr><img src="/img/hoffman4.gif" class="img" style="float: left; margin: 20px">
        <p align="justify">
        ...
        <p align="justify">
            ...
            pedagogicznej ks. Hoffmana. W ostatnich latach życia starał się jeszcze więcej
