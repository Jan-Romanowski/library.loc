...
<div class="container-fluid text-light text-lg-start gx-5 m-0 pb-5" style="background-color: rgba(1,1,1, 0.7); min-height: 100vh; padding-left: 10px; padding-right: 10px; margin-top: 20px; width: 100%;">
        <div class="container-fluid text-center pt-5" >
            <h2 class="mb-5">Dyrygent
                Ks. Michał Roman Szulik
</h2>
        </div>
        <div class="container-fluid text-start gx-5" style="font-size: 16px;">
            <p align="justify"><img src="/img/szulik.jpeg" width="300px" style="margin-left: 25px; float: right;">
    Ukończył PSM II stopnia w Lublinie w klasie śpiewu solowego prof. Aliny Naumowicz.
Swoje umiejętności śpiewacze doskonalił także u Prof. Jadwigi Gałeskiej-Trit (Poznań), Alicji Molędy-Borkowskiej (Drezno) oraz prof. Gerlinde Schmid - Nafz
...
W roku 2005 uzyskał w Akademii Muzycznej w Poznaniu tytuł doktora sztuki muzycznej
            ...
            <ul>
                <li>
                    "Te Deum laudamus" - na sopran solo, chór mieszany, zespół instrumentów dętych i organy
                    (prawykonanie - styczeń 2001, 6 koncertów w diecezji siedleckiej)
                </li>
                <li>
                    Mottet "Evangelio oboedientia. Eucharistia." - na 3 chóry mieszane, kwartet dęty i organy
                    (prawykonanie - czerwiec 2002)
                </li>
                <li>
                    "Requiem f-moll" - na sopran i tenor solo, chór mieszany i organy (prawykonanie - lipiec 2004,
                    koncert w Überlingen 2005)
                </li>
                <li>
                    Psalm 150 - na chór mieszany i organy (prawykonanie - listopad 2004)
                </li>
            </ul>
            </p>
        </div>
