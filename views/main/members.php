    ...
    <div class="container-fluid row justify-content-center p-5">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 container-fluid mb-5">
            ...
            <table>
                <tr>
                    <td class="text-center">
                        <img class="float-start" alt='Martyna Jurzyk' title='Martyna Jurzyk' id="jm" src="/img/2.jpg" width="180px" class = "img" style="margin-right: 20px;">
                    </td>
                    <td class="text-center w-100">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 container-fluid mb-5">
            ...
            <table>
                <tr>
                    <td class="text-center">
                        <img class="float-start" alt='Michał Kiryluk' title='Michał Kiryluk' id="jm" src="/img/portret2.jpg" width="180px" class = "img" style="margin-right: 20px;">
                    </td>
                    <td class="text-center w-100">
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6 container-fluid mb-5">
            ...
            <table>
                <tr>
                    <td class="text-center">
                        <img class="float-start" alt='Maria Stańczuk' title='Maria Stańczuk' height="240px" id="jm" src="/img/maryla.jpg" width="180px" class = "img" style="object-fit: cover; margin-right: 20px;">
                    </td>
                    <td class="text-center w-100">
