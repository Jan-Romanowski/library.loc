...
<div class='container mt-sm-1 mt-md-3' style='min-height: 100vh'>
    ...
    <div class="row align-items-start mb-3">
        <div class="p-5 mt-4 border bg-light row align-items-center">
            <div class="col-sm-12 col-md-5 m-1">
                <h1><?php echo $songsItem['name_song']; ?></h1><br>
                <a href="#" class="btn btn-outline-dark p-5 mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" fill="currentColor" class="bi bi-music-note" viewBox="0 0 16 16">
