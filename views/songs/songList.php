                ...
                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3 col-md-3 m-1">
                    <form action="/songs/applyFilters/" method="post">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input kek"  type="checkbox" role="switch" name="checkBoxJ" id="checkBoxJ"
                ...
                <table class='table table-hover mx-auto p-3'>
                    ...
                    foreach ($songsList as $songsListItem): ?>
                        <tr class="h_anim" onclick="document.location = '/songs/<?php echo $songsListItem['id_song'];?>';">
                            ...
                            <td class="">
                                <a href="/songs/<?php echo $songsListItem['id_song'];?>" class="btn btn-outline-dark float-end">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="23" fill="currentColor" class="bi bi-music-note-beamed" viewBox="0 0 16 16">
...
<!--                            <td>--><?php //echo $songsListItem['count'] ?><!--</td>-->
                            <td>
                                <?php if($songsListItem['actual'] == 0){ ?>
                                    <a class="<?php if(!User::checkRoot("moder") && !User::checkRoot("admin")) echo 'btn disabled'; ?>" href="/songs/changeActual/<?php echo $songsListItem['id_song'];?>" <?php if(isset($songsListItem) && $songsListItem['one_voice']==1) echo "style='color: #f3a123';" ?>>
