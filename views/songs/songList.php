        ...
        <div class="row align-items-start mb-3">
            <div class="m-3 col-3">
                ...
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="checkBoxJ" onchange="filt()">
                    <label class="form-check-label" for="checkBoxJ">Pokazuj utwory jednogłosowe</label>
                </div>
                <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="checkBoxW" onchange="filt()" checked>
